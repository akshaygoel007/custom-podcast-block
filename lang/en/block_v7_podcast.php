...
$string['configtitle'] = 'Listen to Behavioral Health Today';
$string['v7_podcast:addinstance'] = 'Listen to Behavioral Health Today';
$string['v7_podcast:myaddinstance'] = 'Add a new HTML block to Dashboard';
$string['newv7podcastblock'] = 'Listen to Behavioral Health Today';
$string['pluginname'] = 'V7 Podcast';
